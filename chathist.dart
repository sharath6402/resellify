...
class _histState extends State<chatpage> {
  ...
  Future<void> fetchData() async {
    final url = 'http://localhost/api/phpBackEnd/src/getdata.php';
  ...
  Future<void> sendMessage(String message, int sender) async {
  ...
  Future<List<Product>> fetchProducts() async {
    final url = 'http://localhost/api/phpBackEnd/src/get_products.php';
    final response = await http.get(Uri.parse(url));
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  sendMessage(_messageController.text, 10);
...
class chatdemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isSenderSharath = sender == 'sharath';
